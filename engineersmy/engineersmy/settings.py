"""
Django settings for engineersmy project.
...
SECRET_KEY = 'gy_e+-xjk5%y#_0^b&bdu&$3gs!+9d+4oy2&u5*flc$_ve=p%c'
...
WSGI_APPLICATION = 'engineersmy.wsgi.application'
...
TIME_ZONE = os.environ.get('EMY_SERVICE_TIME_ZONE', 'UTC')
